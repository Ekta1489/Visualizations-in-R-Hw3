...
Loading the BRFSS data and cleaning the data. Formatted the data to use
appropriate variable names. Filtered the topic to “Overall Health”,
...
(that is, make a plot showing a line for each state across years. This
spaghetti plot looks
messy.
