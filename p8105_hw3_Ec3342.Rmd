...
```
* The total number of rows in accel_data are `r nrow(accel_data)` and the total number of columns are `r ncol(accel_data)`.
...
#In Week 1, the total activity on Monday was low but the total activity on Monday increased on Week 3.
#In Week 4 and Week 5, the total activity on Saturday has appreciable decreased.
